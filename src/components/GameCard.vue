    ...
    <div style="width: 100%">
      <div class="cardTitle">
        <div style="height: 200px">
          ...
          <i class="em" :class="card.emoji_class"></i>
        </div>
      </div>

      <hr>

      <div style="padding: 0px 5px 0 5px; display: flex;">
        <button @click="$emit('cardRejected', card); hideCard();" style="flex-grow: 1; margin: 0 0.5em 0 0.5em">No</button>
        <button @click="$emit('cardAccepted', card); hideCard();" style="flex-grow: 1; margin: 0 0.5em 0 0.5em">Yes</button>
      </div>

      <!--div style="padding: 0px 5px 0 5px; display: flex;">
        <button style="flex-grow: 1; margin: 0 0.5em 0 0.5em">No</button>
        <button style="flex-grow: 1; margin: 0 0.5em 0 0.5em">A little</button>
        <button style="flex-grow: 1; margin: 0 0.5em 0 0.5em">Very</button>
      </div-->
    </div>
  </div>
</template>
